...
QT_MOC_LITERAL(1, 7, 15), // "receivedMessage"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7), // "message"
QT_MOC_LITERAL(4, 32, 16), // "connectionStatus"
QT_MOC_LITERAL(5, 49, 9), // "connected"
QT_MOC_LITERAL(6, 59, 11), // "onReadyRead"
QT_MOC_LITERAL(7, 71, 14), // "makeConnection"
QT_MOC_LITERAL(8, 86, 15), // "sendScpiCommand"
QT_MOC_LITERAL(9, 102, 7), // "command"
QT_MOC_LITERAL(10, 110, 15) // "closeConnection"

    },
    "Serial\0receivedMessage\0\0message\0"
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::receivedMessage)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::connectionStatus)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Serial::receivedMessage(QString _t1)
{
...
// SIGNAL 1
void Serial::connectionStatus(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };

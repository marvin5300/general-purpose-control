/****************************************************************************
** Meta object code from reading C++ file 'CLogger.h'
**
...
#error "The header file 'CLogger.h' doesn't include <QObject>."
...
void CLogger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->write((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

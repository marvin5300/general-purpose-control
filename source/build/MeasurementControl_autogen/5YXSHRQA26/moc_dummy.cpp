...
#include <memory>
#include "../../../include/devices/dummy.h"
...
QT_MOC_LITERAL(1, 6, 17), // "onReceivedMessage"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "message"
QT_MOC_LITERAL(4, 33, 12), // "queueMeasure"
QT_MOC_LITERAL(5, 46, 5) // "count"

    },
    "Dummy\0onReceivedMessage\0\0message\0"
    "queueMeasure\0count"
};
...
void Dummy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Dummy *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->onReceivedMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->queueMeasure((*reinterpret_cast< quint64(*)>(_a[1]))); break;
        default: ;
        }
    }
}
